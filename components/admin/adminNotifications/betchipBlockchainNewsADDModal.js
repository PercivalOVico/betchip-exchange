...
const BetchipBlockchainNewsADDModal = () => {
  return (
    <Fragment>
         <div id="BetchipBlockchainNewsADDModal" class="modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
...
export default BetchipBlockchainNewsADDModal