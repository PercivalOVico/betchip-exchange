...
const ClientSideNavBarMobile = ({ twTokens, sanityTokens, walletAddress, connectWallet }) => {
  ...
  return (
         <Fragment>
            ...
            <ul class="border-t border-white/[0.08] py-5 hidden">
                <li>
                    <a class="menu menu--active" onClick={() => {router.push('../../../client/clientDashboardd');}}>
                ...
                <li>
                    <a class="menu" onClick={() => {router.push('../../../client/clientProfile');}}>
                 ...
                 <li>
                    <a  class="menu" onClick={() => {router.push('../../../client/clientNotifications');}}>
                        <div class="menu__icon"> <i data-lucide="file-text"></i> </div>
                        <div class="menu__title"> Notifications <i data-lucide="chevron-down" class="menu__sub-icon "></i> </div>
                    </a>
                    <ul class="">
                        <li>
                            <a href="side-menu-dark-users-layout-1.html" class="menu">
                ...
                <li>
                    <a class="menu" onClick={() => {router.push('../../../client/clientWallet');}}>
                        <div class="menu__icon"> <i data-lucide="layout"></i> </div>
                        <div class="menu__title"> Wallet <i data-lucide="chevron-down" class="menu__sub-icon "></i> </div>
                    </a>
                    <ul class="">
                        <li>
                ...
                <li class="menu__devider my-6"></li>
                <li>
                    <a class="menu" onClick={() => {router.push('../../../client/clientP2P');}}>
                ...
                <li>
                    <a class="menu" onClick={() => {router.push('../../../client/clientP2PTerminal');}}>
                        <div class="menu__icon"> <i data-lucide="sidebar"></i> </div>
                        <div class="menu__title"> P2P Terminal <i data-lucide="chevron-down" class="menu__sub-icon "></i> </div>
                    </a>
                    <ul class="">
                        <li>
...
export default ClientSideNavBarMobile