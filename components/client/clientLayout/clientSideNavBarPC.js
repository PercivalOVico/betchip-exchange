  ...
  return (
         <Fragment>
                ...
                <a href="" class="intro-x flex items-center pl-5 pt-4">
                    ...
                    <span class="hidden xl:block text-white text-lg ml-3"> BETCHIP EXCHANGE </span> 
                </a>
                <div class="side-nav__devider my-6"></div>
                <ul>
                    <li>
   
                        <a class="side-menu side-menu--active" onClick={() => {router.push('../../../client/clientDashboardd');}}>
                    ...
                    <li>
                        <a class="side-menu"  onClick={() => {router.push('../../../client/clientProfile');}}>
                     ...
                     <li>
                        <a class="side-menu" onClick={() => {router.push('../../../client/clientNotifications');}}>
                    ...
                    <li class="side-nav__devider my-6"></li>
                    <li>
                        <a  class="side-menu" onClick={() => {router.push('../../../client/clientWallet');}}>
                       ...
                       <li>
                        <a class="side-menu" onClick={() => {router.push('../../../client/clientTransactions');}}>
                    ...
                    <li class="side-nav__devider my-6"></li>
                    <li>
                        <a class="side-menu" onClick={() => {router.push('../../../client/clientP2P');}}>
                    ...
                    <li>
                        <a class="side-menu" onClick={() => {router.push('../../../client/clientP2PTerminal');}}>
...
export default ClientSideNavBarPC