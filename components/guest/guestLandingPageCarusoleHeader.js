...
function GuestLandingPageCarusoleHeader() {
  return (
    <Fragment>
         <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
                ...
                <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                    <button class="btn btn-primary shadow-md mr-2">Join P2P For Free</button>
...
export default GuestLandingPageCarusoleHeader