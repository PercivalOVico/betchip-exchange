...
const AdminLogin = () => {
  ...
  const submitHandler = async ({ email, password }) => {
    try {
      const { data } = await axios.post('/api/admins/adminLogin', {
        email,
        password,
      });
  ...
  return (
    <Fragment>
    <BetchipAdminAuth title="AdminLogin">
            ...
            <div class="block xl:grid grid-cols-2 gap-4">
                ...
                <div class="hidden xl:flex flex-col min-h-screen">
                    <a href="" class="-intro-x flex items-center pt-5">
                        ...
                        <span class="text-white text-lg ml-3"> ADMIN !! BETCHIP EXCHANGE </span> 
                    </a>
                    <div class="my-auto">
                        ...
                        <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10">
                            ...
                            <br/>
                            sign in to your BETCHIP ADMINISTRATIVE account.
                        </div>
                        ...
                        <div class="intro-x flex text-slate-600 dark:text-slate-500 text-xs sm:text-sm mt-4">
                         <div class="flex items-center mr-auto" >
                              ...
                              <a href="">Do not have an account?{' '}
                               <NextLink href={`/auth/admin/adminRegister?redirect=${redirect || '/admin/Dashboard'}`} passHref>
                               <Link>Register</Link>
                              </NextLink>
                              </a> 
                        </div>
